...
const PARTICLE_MODAL_HTML = read(joinpath(@__DIR__, "particle_modal.html"), String)
const COMPLETE_HTML_TEMPLATE = string(
    """<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        ...
        <div id="mapModal" class="modal" style="display: none;">
            ...
            <canvas id="sectionCanvas" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; z-index: 1000; display: none;"></canvas>
    <canvas id="particleCanvas" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; z-index: 1001; display: none;"></canvas>
    <canvas id="interactiveCanvas" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: auto; z-index: 1002; display: none;"></canvas>
            ...
            <div class="controls-container">
                ...
                <div class="form-group">
                    ...
                    <select id="parameterSelect">
                        ...
                        <option value="UVz">Модуль скорости</option>
                ...
                <div class="form-group">
                    ...
                    <select id="forecastSelect">
                        ...
                        <option value="72">+72 часов</option>
                        <option value="96">+96 часов</option>
                        <option value="120">+120 часов</option>
                        <option value="144">+144 часов</option>
...
<div id="sectionModal" style="display: none; position: fixed; z-index: 10001; left: 20px; bottom: 20px; width: 320px; background: white; padding: 20px; border-radius: 8px; box-shadow: 0 0 15px rgba(0,0,0,0.4);">
    <div style="text-align: center;">
        ...
        <!-- Упрощенное поле ввода глубины -->PARTICLE_MODAL_HTML
